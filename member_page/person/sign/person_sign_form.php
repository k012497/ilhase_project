...
<head>
    ...
    <link rel="stylesheet" href="../css/person_sign_form.css">
    ...
    <div id="wrap_inner">
      ...
      <div class="visual">
        ...
        <div class="check_box">
          ...
          <div class="input1">
              <input type="password" id="pass_2" size="50" ><br>
        ...
        <div class="check_box">
          ...
          <div class="input1">
            <input type="text" value="" size="50" id="name" name="name"><br>
        ...
        <div class="check_box">
          ...
          <div class="input2">
            <div id="check_callnum">
                <div id="check_callnum_box">
                  <div id="check_callnum_inner">
                    <input type="text" class="input_checkclallnum" value="" size="50"  name="phone" id="phone">
                    <input type="button" value="인증" id="button_1">
                  </div>
                  <input type="text" class="input_checkclallnum" value="" id="phone_num"size="50" >
                  <h3 id='valueSub'></h3>
        ...
        <div class="check_box">
          ...
          <div class="input1">
            <input type="text" value="" size="50"  id="email" name="email"><br>
            <h4 id="email_sub" ></h4>
          </div>
        </div>
        <div class="check_box">
          ...
          <div class="input1">
            <input type="text" value="" size="20" id="birth" name="birth">
            <span id="span_tag"> - </span>
            <input type="text" value="" size="1" id="gender"name="gender"><span id="span_tag2">******</span><br>
            <h4 id="birth_sub" ></h4>
          </div>
        </div>
        <div id="check_address_box" class="check_box">
          <div class="div1">
            <h3>7/8</h3>
            <h1>주소를 입력해주세요</h1>
          </div>
          <div id="address_box">
            <input type="text" class="column column_left" id="sample4_postcode" placeholder="우편번호" size="30" name="postcode">
            <input type="button" id="btn_address_check" class="column_right" onclick="sample4_execDaumPostcode()" value="우편번호 찾기"><br>
            <input type="text" class="column column_left" id="sample4_roadAddress" placeholder="도로명주소" size="30" name="roadAddress">
            <input type="text" class="column column_right" id="sample4_jibunAddress" placeholder="지번주소" size="30" name="jibunAddress">
            <span id="guide" class="column column_right" style="color:#999;display:none"></span><br>
            <input type="text" class="column column_left" id="sample4_detailAddress" placeholder="상세주소" size="30">
            <input type="text" class="column column_right" id="sample4_extraAddress" placeholder="참고항목" size="30" >
            <div class="input1">
              <h4 id="adress_sub"></h4>
            </div>
          </div>
        </div>
        <div id="provision" class="check_box">
          <div class="div1">
            <h3>마지막 단계입니다.</h3>
...
일하세 내의 개별 서비스 이용, 이벤트 응모 및 경품 신청 과정에서 해당 서비스의 이용자에 한해 추가 개인정보 수집이 발생할 수 있습니다. 추가로 개인정보를 수집할 경우에는 해당 개인정보 수집 시점에서 이용자에게 ‘수집하는 개인정보 항목, 개인정보의 수집 및 이용목적, 개인정보의 보관기간’에 대해 안내 드리고 동의를 받습니다.
...
참고로 일하세는 ‘개인정보 유효기간제’에 따라 1년간 서비스를 이용하지 않은 회원의 개인정보를 별도로 분리 보관하여 관리하고 있습니다.
          ...
          <input type="button" name="" id="submit_1" value="동의하고 등록하기">
          </div>
        </div>
